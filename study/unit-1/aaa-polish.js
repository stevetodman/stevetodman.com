(function () {
  ...
  var ENCOUNTERS={
    ...
    ink:{name:'Ink Slime',theme:'ruins',pitch:420,taunt:'Careful! I can make absolutely anything look like homework.',ready:'The Ink Slime ripples across the ruined floor.',hit:'The slime splashes apart, then pulls itself together.',counter:'The Ink Slime snaps a ribbon of shadowy ink.',victory:'The last ink ripple sinks into the stones.'},
    beetle:{name:'Clockwork Beetle',theme:'crystal',pitch:260,taunt:'My gears are calibrated. Mostly. Please ignore that spring.',ready:'The Clockwork Beetle ticks beneath the crystal arches.',hit:'Its brass shell rattles and a gear skips a tooth.',counter:'The Clockwork Beetle winds up and charges on clicking legs.',victory:'The beetle powers down with one last metallic tick.'},
    drake:{name:'Crystal Drake',theme:'crystal',pitch:610,taunt:'These wings are not decorative. The glitter absolutely is.',ready:'The Crystal Drake watches from a ridge of blue crystal.',hit:'Light fractures across the drake’s crystal scales.',counter:'The Crystal Drake sweeps its wings and releases a bright shard-burst.',victory:'The drake folds its wings and the crystals grow quiet.'}
  };
