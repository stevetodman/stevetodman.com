...
export const CASES: ClinicalCase[] = [
  ...
  {
    id: "case-msk-chest-pain",
    patientName: "Jordan Blake",
    age: 13,
    sex: "M",
    chiefComplaint: "Chest pain with push-ups in PE",
    room: "Room 4",
    vibe: "A 13-year-old in a PE shirt sits swinging his legs. He points to the left chest wall when you walk in. His mother looks more worried than he does.",
    parentPresent: true,
    correctDiagnosis: "Musculoskeletal chest pain",
    differentials: [
    ...
    history: [
      { key: "generic", question: "What brought you in today?", answer: "It hurts here when I do push-ups or when I laugh hard. Started after PE last week." },
      { key: "activity_level", question: "Does it happen during running, or only with pressing / stretching?", answer: "Running is fine. Push-ups, lifting, and when I poke it — that's when it hurts.", redFlag: true },
      { key: "palpitations", question: "Any racing heart, fainting, or pain that makes you stop mid-sprint?", answer: "No fainting. No racing. I can keep playing basketball." },
      { key: "viral_illness", question: "Any recent fever, vomiting, or flu-like illness?", answer: "No. He hasn't been sick." },
      { key: "family_sudden_death", question: "Any sudden death or young heart disease in the family?", answer: "No." },
      { key: "substance_use", question: "Any energy drinks, vaping, or stimulants?", answer: "No.", confidential: true },
    ],
    exam: {
      general: "Well-appearing. Comfortable at rest. Reproduces the pain by pressing his own costochondral junction.",
      vitals: { HR: 76, BP: "110/66", RR: 16, SpO2: 99 },
      auscultation: [
        { site: "RUSB", description: "Normal S1, S2. No rub." },
        { site: "LUSB", description: "Normal S1, S2. No murmur." },
        { site: "LLSB", description: "Normal S1, S2. No murmur or rub." },
        { site: "Apex", description: "Normal S1, S2." },
      ],
      femoralPulses: "2+ bilaterally, symmetric.",
      extras: ["Point tenderness at the left 4th–5th costochondral junction.", "Pain reproduced by horizontal arm adduction.", "No fever. No respiratory distress."],
    },
    ecg: { rhythm: "Sinus rhythm", rate: 74, intervals: { PR: "140 ms", QRS: "86 ms", QTc: "404 ms" }, axis: "Normal", keyFindings: ["Normal sinus rhythm", "No ST elevation", "No low voltage"], pattern: "normal" },
    echo: { summary: "Structurally normal heart.", keyFindings: ["Normal function", "No effusion", "No wall-motion abnormality"], anomaly: "normal" },
    appropriateTests: [],
    unnecessaryTests: ["ECG", "Echocardiogram", "Troponin", "BNP", "Cardiac MRI", "CXR"],
    correctManagement: [
      "Reassure — musculoskeletal / costochondral pain",
      "Continue usual activity as tolerated",
      "Supportive chest-wall care and return precautions",
    ],
    redFlagKeys: ["activity_level", "viral_illness"],
    teachingPoint: "Most pediatric chest pain is musculoskeletal. Reproducible wall tenderness, no exertional cardiac symptoms, and a normal exam do not require ECG, echo, or biomarkers. Contrast this with postviral myocarditis.",
    missedOpportunityTemplate: {
      activity_level: "You did not ask whether the pain is positional or reproducible. That is the discriminating musculoskeletal feature.",
      viral_illness: "You did not ask about a recent viral prodrome. That question is how you keep myocarditis on (or off) the table.",
    },
    attendingSocratic: [
      "What one exam finding here makes extensive testing low-yield?",
      "How would your workup change if this pain started during a sprint after a viral illness?",
      "What are you telling the family about sports this week?",
    ],
  },
  {
    id: "case-adolescent-htn",
    patientName: "Priya Shah",
    age: 16,
    sex: "F",
    chiefComplaint: "High blood pressure at school sports physical",
    room: "Room 1",
    vibe: "A 16-year-old sits with her mother. She is overweight and looks embarrassed. She says she feels fine.",
    parentPresent: true,
    allowConfidentialInterview: true,
    correctDiagnosis: "Primary hypertension",
    differentials: [
      "White-coat hypertension",
      "Primary hypertension",
      "Coarctation of the aorta",
    ...
    history: [
      { key: "generic", question: "What brings you in?", answer: "School said her BP was 142/88 at the sports physical. One reading. They sent us here." },
      { key: "activity_level", question: "Activity, diet, sleep, and any headaches or vision changes?", answer: "She is mostly sedentary. Drinks a lot of soda. No vision changes. Occasional headaches when she stays up late." },
      { key: "pmh", question: "Prior blood pressures, kidney disease, or premature birth?", answer: "A couple of 'high' nurse readings last year were never repeated. Born at term. No known kidney disease." },
      { key: "meds", question: "Medications, OCPs, stimulants, NSAIDs?", answer: "Ibuprofen sometimes for cramps. No OCP. No ADHD meds." },
      { key: "family_sudden_death", question: "Family history of hypertension, kidney disease, or early heart disease?", answer: "Both parents have hypertension. No sudden death." },
      { key: "substance_use", question: "Energy drinks, nicotine, or other substances?", answer: "Energy drinks before exams. Please don't make a big deal.", confidential: true },
    ],
    exam: {
      general: "BMI at the 95th percentile. Comfortable. No Cushingoid features.",
      vitals: {
        HR: 82,
        BP: "138/86",
        RR: 16,
        SpO2: 99,
        fourLimbBP: { RA: "138/86", LA: "136/84", RL: "142/88", LL: "140/86" },
      },
      auscultation: [
        { site: "RUSB", description: "Normal S1, S2. No murmur." },
        { site: "LUSB", description: "Normal S1, S2. No murmur." },
      ...
      femoralPulses: "2+ and simultaneous with brachials. No radial-femoral delay.",
      extras: [
        "Correct cuff size used; seated, back supported, feet on floor.",
        "Repeat auscultatory BP after 5 minutes still elevated but lower than the school reading.",
        "No abdominal bruit.",
      ],
    },
    ecg: { rhythm: "Sinus rhythm", rate: 80, intervals: { PR: "148 ms", QRS: "88 ms", QTc: "410 ms" }, axis: "Normal", keyFindings: ["No LVH", "Normal repolarization"], pattern: "normal" },
    echo: { summary: "Structurally normal heart without target-organ findings on this study.", keyFindings: ["Normal LV mass", "Normal function", "No coarctation"], anomaly: "normal" },
    appropriateTests: ["ABPM"],
    unnecessaryTests: ["ECG", "Echocardiogram", "Cardiac MRI", "CT angiography", "Troponin", "Holter"],
    correctManagement: [
      "Do not start antihypertensive therapy from a single school reading",
      "Arrange 24-hour ABPM to confirm hypertension",
      "Lifestyle counseling (sodium, activity, weight, energy drinks)",
      "Repeat properly measured office BP",
    ],
    redFlagKeys: ["pmh", "family_sudden_death"],
    teachingPoint: "One school BP is not a diagnosis. Confirm technique, compare four-limb BPs to exclude coarctation, then use ABPM before labeling or medicating an adolescent. Echo is for confirmed hypertension, not the first unconfirmed reading.",
    missedOpportunityTemplate: {
      pmh: "You did not ask about prior readings or kidney history. That is how you sort incident 'high BP' from a missed chronic problem.",
      family_sudden_death: "You did not take a hypertension / premature CVD family history, which supports primary hypertension once coarctation is excluded.",
    },
    attendingSocratic: [
      "What must you do before you write 'hypertension' in the chart?",
      "How do four-limb BPs and femorals change this visit versus Diego's?",
      "When is an echocardiogram indicated — today, or after ABPM?",
    ],
  },
];
