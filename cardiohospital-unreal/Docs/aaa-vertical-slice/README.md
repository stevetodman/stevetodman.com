...
| [CONTENT_FOLDERS.md](./CONTENT_FOLDERS.md) | Content/ directory map |
| [IMAGINE_PROMPTS.md](./IMAGINE_PROMPTS.md) | 2D Grok Imagine reference prompts |

Clinical truth remains in LegacyCore + `Content/Data`. These docs do not change case content.
